...
int udsBootloaderInit(void *self, const void *cfg, Iso14229Instance *iso14229);
int udsBootloaderPoll(void *self, Iso14229Instance *iso14229);

#define UDSBOOTSOFTWARE_MIDDLEWARE(self_obj, cfg_obj)                                              \
    {                                                                                              \
